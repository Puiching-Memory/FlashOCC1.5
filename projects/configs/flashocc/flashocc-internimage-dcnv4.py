_base_ = ['../../../third_party/mmdetection3d-1.0.0rc4/configs/_base_/datasets/nus-3d.py',
...
# ---- InternImage-Tiny with DCNv4 ----
# depths=(4,4,18,4), channels=64 => stage output channels: [64, 128, 256, 512]
# out_indices=(2,3) => neck receives [256, 512]
model = dict(
    type='BEVDetOCC',
    img_backbone=dict(
