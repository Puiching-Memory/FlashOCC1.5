...
def mmlabNormalize(img, channel_order='BGR'):
    ...
    if channel_order == 'BGR':
        # PIL outputs RGB; swap to BGR for backward compatibility.
        img = img[..., ::-1]
...
class PrepareImageInputs(object):
    def __init__(
        ...
        self.channel_order = self.data_config.get('channel_order', 'BGR').upper()
    ...
    def get_inputs(self, results, flip=None, scale=None):
        ...
        for cam_name in cam_names:
            ...
            imgs.append(mmlabNormalize(img, self.channel_order))
            ...
            if self.sequential:
                ...
                for adj_info in results['adjacent']:
                    ...
                    img_adjacent = self.img_transform_core(
                        ...
                        flip=flip,
                        rotate=rotate)
                    imgs.append(mmlabNormalize(img_adjacent, self.channel_order))
